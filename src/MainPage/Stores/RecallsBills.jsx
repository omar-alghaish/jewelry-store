...
const RecallsBillsList = () => {
  ...
  const handleShow = (record) => {
    ...
    db.put("productRecallsBills", JSON.stringify(allstore));
    handleGetAll();
  };
  useEffect(() => {
        ...
        <div className="content">
          <div className="page-header">
            <div className="page-title">
              <h4>قائمه المسحوبات من المخزن </h4>
...
export default RecallsBillsList;
