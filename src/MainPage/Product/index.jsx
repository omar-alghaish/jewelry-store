...
import AddCaliber from "./AddCaliber";
import CaliberList from "./CaliberList";
import EditCaliber from "./EditCaliber";
const ProductRoute = ({ match }) => (
  <Switch>
    ...
    <Route path={`${match.url}/addkart`} component={AddCaliber} />
    <Route path={`${match.url}/caliber`} component={CaliberList} />
    ...
    <Route path={`${match.url}/editcaliber-product`} component={EditCaliber} />
    <Route
    ...
    <Route
      path={`${match.url}/editcategory-product`}
      component={EditCategory}
    />
    <Route
      path={`${match.url}/subcategorytable-product`}
    ...
    <Route
      path={`${match.url}/importproduct-product`}
      component={ImportProduct}
    />
    <Route
      path={`${match.url}/printbarcode-product`}
